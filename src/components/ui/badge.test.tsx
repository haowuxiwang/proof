...
describe('Badge', () => {
  ...
  it('applies custom className', () => {
    ...
    expect(screen.getByText('Custom')).toHaveAttribute('class', expect.stringContaining('custom'));
  });
});
...
describe('badgeVariants', () => {
  ...
  it('returns a string for each variant', () => {
    ...
    expect(typeof badgeVariants({ variant: 'ghost' })).toBe('string');
    expect(typeof badgeVariants({ variant: 'link' })).toBe('string');
  });
});
